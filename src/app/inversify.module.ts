...
import PostingPostId from './data-binding/Model/PostingPostId';
...
const module = new AsyncContainerModule(
  async (
    ...
    bind<PostPageElement>(SYMBOLS.PostPageElement).to(PostPageElement).inSingletonScope();
    ...
    bind<PostingPostId>(SYMBOLS.PostingPostId).to(PostingPostId).inSingletonScope();
